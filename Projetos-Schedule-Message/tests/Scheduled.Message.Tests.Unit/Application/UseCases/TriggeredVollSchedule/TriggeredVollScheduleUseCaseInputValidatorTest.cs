...
public class TriggeredVollScheduleUseCaseInputFakerValidatorTest
{
     private readonly IValidator<TriggeredVollScheduleUseCaseInput> _validator;

    public TriggeredVollScheduleUseCaseInputFakerValidatorTest()
    {
        ValidatorOptions.Global.LanguageManager.Culture = new CultureInfo("en");
        _validator = new TriggeredVollScheduleUseCaseInputValidator();
    }
    ...
    public void Should_Validate_Input_With_Error_When_Date_When_Invalid()
    {
        ...
        var input = TriggeredVollScheduleUseCaseInputFaker.Create(date);
    ...
    {
        // Arrange
        var input = TriggeredVollScheduleUseCaseInputFaker.Create(jobName: jobName!);
    ...
    {
        // Arrange
        var input = TriggeredVollScheduleUseCaseInputFaker.Create(topicName: topicName!);
    ...
    {
        // Arrange
        var input = TriggeredVollScheduleUseCaseInputFaker.Create(key: key!);
